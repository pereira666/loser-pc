    ...
    try {
        ...
        case 'nobg':
			if (isMedia && type === 'image' || isQuotedImage) {
				...
				await kill.sendImageAsSticker(from, `data:${nobgmd.mimetype};base64,${result.base64img}`, { author: '☆ 5584500845 ☆', pack: '🤖 Loser BOTS 🌟', keepScale: true })
       ...
       case 'translate':
        ...
        case 'criador':
			await kill.reply(from, `☀️ - Criador: https://wa.me/558499034946`, id)
            break
